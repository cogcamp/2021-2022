...
mainScene.config = function() {
    // 背景色の設定
    this.cameras.main.setBackgroundColor('#DC143C');
...
mainScene.createBall = function() {
    // ボール作成
    this.ball=this.physics.add.image(400,400,"ball2");
...
mainScene.createPaddle = function() {
     // パドル作成
    this.paddle=this.physics.add.image(400,550,"paddle3");
    this.paddle.setDisplaySize(104,104);
...
mainScene.createBlocks = function() {
    // 横6列、縦10行並べる
    //ブロックの色の配列
    var blockColors=["red1","purple1","red1","purple1","red1","purple1","red1",
    "purple1","red1","purple1"];
